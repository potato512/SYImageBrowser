...
@interface ImageLoopTrueTableVC ()

@end

@implementation ImageLoopTrueTableVC
...
//    SYImageBrowse *imageBrowse = [[SYImageBrowse alloc] initWithFrame:rect view:self.view];
    // 方法2
    SYImageBrowseView *imageBrowse = [[SYImageBrowseView alloc] initWithFrame:rect view:nil];
...
//    imageBrowse.pageControlPoint = CGPointMake((imageBrowse.frame.size.width - imageBrowse.pageControl.frame.size.width), (imageBrowse.frame.size.height - imageBrowse.pageControl.frame.size.height));
    ...
    imageBrowse.pageLabelFrame = CGRectMake(10.0, 10.0, 40.0, 40.0);
    //
    imageBrowse.pageIndex = 3;
    // 标题
    imageBrowse.showText = YES;
    imageBrowse.textLabelFrame = CGRectMake(60.0, 10.0, 40.0, 40.0);
    //
    ...
    table.tableHeaderView = imageBrowse;
